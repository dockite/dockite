    ...
    return {
      name: [
        ...
        },
        {
          pattern: /^[a-z0-9\-_]+$/,
          message:
            'The field name must only contain alphanumeric characters, dashes and underscores',
          trigger: 'blur',
        },
        {
